...
class WpcomAdapter:
    ...
    def set_post_categories(self, post_id, category_ids,
        ...
        # we need before hitting the remote endpoint: categories_by_id
    ...
    def update_category(self, term_id, fields):
        ...
        # ID-based updates cannot create duplicate categories. It also
        # skips the NULL-byte substitution below: v2 sends JSON, which
